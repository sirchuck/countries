...
var cs = [
  ["United States of America","US","USA","840",[
    ["AL","Alabama"],["AK","Alaska"],["AS","American Samoa"],["AZ","Arizona"],["AR","Arkansas"],["CA","California"],["CO","Colorado"],["CT","Connecticut"],["DE","Delaware"],["DC","District of Columbia"],["FL","Florida"],
    ...
    ["MH","Marshall Islands"],["MA","Massachusetts"],["MI","Michigan"],["FM","Micronesia"],["MN","Minnesota"],["MS","Mississippi"],["MO","Missouri"],["MT","Montana"],["NE","Nebraska"],["NV","Nevada"],
    ["NH","New Hampshire"],["NJ","New Jersey"],["NM","New Mexico"],["NY","New York"],["NC","North Carolina"],["ND","North Dakota"],["MP","Northern Marianas"],["OH","Ohio"],["OK","Oklahoma"],["OR","Oregon"],
    ["PW","Palau"],["PA","Pennsylvania"],["PR","Puerto Rico"],["RI","Rhode Island"],["SC","South Carolina"],["SD","South Dakota"],["TN","Tennessee"],["TX","Texas"],["UT","Utah"],["VT","Vermont"],["VA","Virginia"],
...
//  ]],
  ...
  ["Ireland","IE","IRL","372",[
    ["","Antrim"],["","Ards"],["","Armagh"],["","Ballymena"],["","Ballymoney"],["","Banbridge"],["","Belfast"],["","Carlow"],["","Cavan"],["","Clare"],["","Cork"],["","Carrickfergus"],["","Castlereagh"],["","Coleraine"],["","Cookstown"],["","Craigavon"],["","Derry"],["","Donegal"],["","Dublin"],["","Down"],["","Dungannon"],["","Fermanagh"],["","Galway"],["","Kerry"],["","Kildare"],["","Kilkenny"],["","Larne"],["","Limavady"],["","Lisburn"],["","Laois"],["","Leitrim"],["","Limerick"],["","Longford"],["","Louth"],["","Magherafelt"],["","Moyle"],["","Mayo"],["","Meath"],["","Monaghan"],["","Newry and Mourne"],["","Newtownabbey"],["","North Down"],["","Offaly"],["","Omagh"],["","Roscommon"],["","Sligo"],["","Strabane"],["","Tipperary"],["","Waterford"],["","Westmeath"],["","Wexford"],["","Wicklow"]
  ]],
...
//  ]],
  ...
  ["Trinidad and Tobago","TT","TTO","780",[
    ["","Tobago"],["","Arima"],["","Caroni"],["","Mayaro"],["","Nariva"],["","Port-of-Spain"],["","Saint Andrew"],["","Saint David"],["","Saint George"],["","Saint Patrick"],["","San Fernando"],["","Victoria"]
  ]],
...
//  ]],
  ...
  ["United Arab Emirates","AE","ARE","804",[
